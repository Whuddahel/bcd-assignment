...
import { GradientText } from "../brand/gradient-text"
        ...
        <div className="glass-card overflow-hidden rounded-2xl transition-all duration-300 hover:shadow-card-hover">
          ...
          <div className={`relative h-52 bg-gradient-to-br ${drop.gradient}`}>
            ...
            <button
              ...
              className={`absolute right-3 top-3 z-10 flex h-8 w-8 items-center justify-center rounded-full backdrop-blur-sm transition-all ${wishlisted ? "bg-pink-500/90 text-white" : "bg-black/40 text-white/70 hover:bg-black/60 hover:text-white"
                }`}
              onClick={(e) => {
                e.preventDefault()
                e.stopPropagation()
